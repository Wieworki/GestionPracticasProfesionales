...
export default function Edit({ administrativo }: AdministrativoProps) {
    ...
    const submit = (e: React.FormEvent) => {
        e.preventDefault();
        patch(route("administrativo.update"));
    };

    return (
        <AdministrativoLayout nombre={administrativo.nombre}>
            <Head title="Modificar Datos - Administrativo" />
            <div className="max-w-3xl mx-auto bg-white shadow rounded-xl p-8">
                ...
                <form onSubmit={submit} className="space-y-5">
                    ...
                    <div className="flex justify-between pt-6">
                        <Link
                            href={route("administrativo.perfil")}
